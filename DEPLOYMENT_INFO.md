...
### Frontend (Vercel)
- **URL**: https://frontend-a607uzeg6-daynashins-projects.vercel.app
...
PORT=10000
TIMEOUT=30000
FRONTEND_URL=https://frontend-a607uzeg6-daynashins-projects.vercel.app
```
...
2. **Frontend 테스트**
   - https://frontend-a607uzeg6-daynashins-projects.vercel.app 접속
   - URL 입력 및 분석 기능 테스트
